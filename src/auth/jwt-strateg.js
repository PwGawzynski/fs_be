...
var JwtStrategy = /** @class */ (function (_super) {
    ...
    function JwtStrategy() {
        ...
        return _super.call(this, {
            ...
            secretOrKey: 'aioubnfiunb[oupsbreiuhrbpsiabuhrguiabipuhgbaiupjhfr[gjhiudnjzpivvnbuipharjsoptiungabipuhefjo[auh[ouafioh' +
                ...
                switch (_a.label) {
                    case 0:
                        if (!payload || !payload.id) {
                            return [2 /*return*/, done(new common_1.UnauthorizedException(), false)];
                        }
